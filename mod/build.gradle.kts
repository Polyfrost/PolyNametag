...
dependencies {
    ...
    if (rootProject.file("mod-compat/build/libs/mod-compat.jar").exists()) {
        modCompileOnly(project(":mod-compat"))
    } else {
        logger.error("-----------------------------------")
        logger.error("-----------------------------------")
        logger.error("-----------------------------------")
        logger.error("COULD NOT FIND mod-compat.jar! WITHOUT IT, THIS MOD WILL **NOT** COMPILE!!")
        logger.error("COULD NOT FIND mod-compat.jar! WITHOUT IT, THIS MOD WILL **NOT** COMPILE!!")
        logger.error("COULD NOT FIND mod-compat.jar! WITHOUT IT, THIS MOD WILL **NOT** COMPILE!!")
        logger.error("Please run `./gradlew :mod-compat:build` to build it.")
        logger.error("-----------------------------------")
        logger.error("-----------------------------------")
        logger.error("-----------------------------------")
    }
